...
export default function GoalsScreen() {
  ...
  const { dailyTargetKwh, sustainabilityTargets, setDailyTarget, toggleTarget } = useGoalsStore()
    ...
    <SafeAreaView className="flex-1 bg-[#F6F7F9]">
      ...
      >
        ...
        <View className="flex-row items-center gap-4 mb-2">
          ...
          <Text className="text-3xl font-bold text-[#111]">Your Goals</Text>
        </View>

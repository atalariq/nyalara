...
- **Setup-complete account**: a signed-in account that has already completed the onboarding flow; device inventory can still be empty because the app allows first-time exploration before the user adds their first device.
